...
find /var/www/copla-editor/sn-editor/static/js/ -type f -exec sed -i "s,\${KEYCLOAK_REALM},${KEYCLOAK_REALM},g" {} \;
find /var/www/copla-editor/sn-editor/static/js/ -type f -exec sed -i "s,\${KEYCLOAK_CLIENTID},${KEYCLOAK_CLIENTID},g" {} \;
...
find /var/www/asclepios-search/ -type f -exec sed -i "s,\${KEYCLOAK_HOST},${KEYCLOAK_HOST},g" {} \;
